...
$gd = imagecreatetruecolor($x*$z*2, $y*$z*2);
  ...
  for($j=0;$j<$y;$j++)
    ...
    for($m=0;$m<$z;$m++)
      ...
      for($n=0;$n<$z;$n++)
        ...
        imagesetpixel($gd, ($x*$z*2)-(($i*$z)+$m)-1,($j*$z)+$n, $col);
        imagesetpixel($gd, ($i*$z)+$m,($y*$z*2)-(($j*$z)+$n)-1, $col);
        imagesetpixel($gd, ($x*$z*2)-(($i*$z)+$m)-1,($y*$z*2)-(($j*$z)+$n)-1, $col);
        }
      }
    }
  }
